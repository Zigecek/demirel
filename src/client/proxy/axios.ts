...
export const get =
  <T>(path: string, params?: any, url?: string, config?: AxiosRequestConfig<any>) =>
...
export const post =
  <T>(path: string, data?: any, url?: string, config?: AxiosRequestConfig) =>
  (dispatch: (data: T, err?: any) => void) => {
